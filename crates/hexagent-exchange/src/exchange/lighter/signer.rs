...
mod tests {
    ...
    //
    // Generated by tools/lighter-katgen (official lighter-go path) with
    ...
    mod kat {
        ...
        // Generated 2026-07-05 with lighter-go via tools/lighter-katgen
        // (production GetCreateOrderTransaction path, chainId 304).
        const GO_PUBKEY_HEX: &str =
            "710c8cd2201061fa5570d20852d90ddabd6c496825b639d6c6486ecb1f859b63f237dee54f3f42b4";
        const GO_CREATE_ORDER_HASH: &str =
            "f9680521fbdaf9dea7685d6daab0e2ae80184f84dc03ffd04de1ad149fcc6afc7fb3de6b45c619da";
        const GO_CANCEL_ORDER_HASH: &str =
            "f5241117e88d80fa16e2d8f33dd2ab660f62774bb52722f898507105f798f5c6aade23b4859d5e7c";
        const GO_CANCEL_ALL_HASH: &str =
            "81079ccf2fccd25ac439e50d4688432f8bf6a9a5db386b7b2d6f19da0143e20357f94a50c4facde1";
        const GO_AUTH_HASH: &str =
            "7987ace00c0c54c4517a80d8703f2d8d22e6b0a3f2ac4a069384180ee099253d3a1300c885a3842d";
        // 80-byte Go signature over GO_CREATE_ORDER_HASH with k=0x2a.
        const GO_CREATE_ORDER_SIG_K42: &str =
            "1f3177bc3ee3830d6230dc1305192601875fe84aee58f08079fd3e5ff1a4e19093d57ee1836cb648352da280a4b95e5cf0fa257eeb03ab2ee174ffedbd033917245fe47cfe59b5c62b8bb41627368378";

        fn assert_kat(name: &str, expected: &str, actual: &str) {
            if expected.is_empty() {
                eprintln!("KAT {} not yet generated — run tools/lighter-katgen", name);
                return;
            }
        ...
        fn go_signature_verifies_in_rust() {
            if GO_CREATE_ORDER_SIG_K42.is_empty() || GO_CREATE_ORDER_HASH.is_empty() {
                eprintln!("KAT go_signature not yet generated — run tools/lighter-katgen");
                return;
            }
            let s = test_signer();
